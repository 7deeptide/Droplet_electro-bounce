...
\begin{figure}[htb]
    \centering
    \resizebox{0.5\textwidth}{!}{\input{../figures/times.pgf}}
...
\begin{figure}[htb]
    \centering
    \resizebox{0.5\textwidth}{!}{\input{../figures/ymaxes.pgf}}
